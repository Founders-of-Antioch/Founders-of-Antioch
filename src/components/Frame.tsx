...
export class Frame extends React.Component<FrameProps, {}>{
    ...
    pointsString() {
        ...
        return (
            `
                ${tipX}, ${tipY},
                ${tipX + (stt * this.props.frameRadius)}, ${tipY + (this.props.frameRadius / 2)},
                ${tipX + (stt * this.props.frameRadius)}, ${tipY + (3 * this.props.frameRadius / 2)},
    ...
    render() {
        return (
            <polyline fill="#00a6e4"
                // stroke="black"
                strokeWidth="3"
                points={this.pointsString()}
                transform={`rotate(${30}, ${this.props.centerX}, ${this.props.centerY})`}
            />
        )
    }
}